...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \vspace{12mm}
    {\Large \bfseries Group: Concrete Creators\par}
...
\item Provided guided C++ practice opportunities that culminate in a small refactor of na\"ive code to FM and a brief transfer d iscussion.
\end{enumerate}
...
C1 $\rightarrow$ C2 $\rightarrow$ C3 $\rightarrow$ MQ3 $\rightarrow$ C4 $\rightarrow$ MQ5 $\rightarrow$ C5 (+ recognition triage) $\rightarrow$ MQ6 $\rightarrow$ C6.\\
\\
